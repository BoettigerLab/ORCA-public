...
%   will be saved. 
%   Available formats:
%   'png' recommended bitmap format, supports alpha transparency
%   'eps' recommended vector graphic, dangerous for complex figures.
%   'fig' matlab's figure format, can restore the figure as it was
%   'ai' adobe illustrator, not recommended.  
...
% April 8, 2014
%
% Modifications by Alistair Boettiger
...
if ~parameters.overwrite
    ...
    if count > 0 && parameters.verbose
        disp(['Found existing files. Appending ' num2str(count) ' to all file names.']);
    end
end
