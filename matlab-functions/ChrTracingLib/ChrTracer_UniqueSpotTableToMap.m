function [dat_table,distMap,allShifts,allShifts_h,distMap2D] = ChrTracer_UniqueSpotTableToMap(spotTable,varargin)
...
if pars.lastSpot > numSpots
    warning('last spot greater than numSpots. reassigning based on spotTable');
    pars.firstSpot = 1;
