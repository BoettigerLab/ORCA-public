function [exactCodebook, allCode2GeneID, correctedCodebook, exactCode2GeneID, correctedCode2GeneID] = GenerateSECDEDCodebook(numDataBits)
...
% Calculate maps and corrected codebook if requested
if nargout >=2
    % Calculate map
