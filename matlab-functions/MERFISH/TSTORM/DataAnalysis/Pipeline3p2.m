...
for o = 1:5
oneWeight = logspace( log10(.001),log10(.5),5);

[bestThetas,initRho,finalRho] = ScanThresholds2(cellProperties,thresholds,initThresh,newPath,'parameters',parameters,'oneWeight',oneWeight(o));
...
disp(['final FPKM correlation = ',num2str(finalRho)]);
    ...
    for c=1:numCells
        ...
        for h=1:numHybes
            newMListName = regexprep(hybeNames{h}{c},'\.dax',['_final_scan',num2str(o),'_alist\.bin']);
