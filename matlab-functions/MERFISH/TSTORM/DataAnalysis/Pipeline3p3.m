function Pipeline3p3(varargin)
% optimizing thresholds for 1000 gene library
...
try
    [bestThetas,initRho,finalRho] = ScanThresholds3(cellProperties,thresholds,initThresh,newPath,'parameters',parameters);
